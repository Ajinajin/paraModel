...
public:
	...
	void DrawRoundPConeSide(Ver3D center, float radius, float height,float radius2, GLboolean ifTrans);
	...
	void DrawFuse(Ver3D center,float bigR,float height1,float smallR,float height2,GLboolean ifTrans);
